    ...
    var h, i, j, k = [],
        ...
        p = {
            ...
            getEndPointUrl: function(a) {
                a = b("getAsyncParams")(o);
                a.bz_orig = "blue";
                a = b("QueryString").appendToUrl(n, a);
            ...
            getTopLevel: function() {
                return m && b("lowerFacebookDomain").isValidDocumentDomain() ? window.top : null
            },
            getUserID: function() {
            ...
            send: function(a, c, d, e) {
                ...
                g.onreadystatechange = function() {
                    if (g.readyState >= 4) {
                        ...
                        a == 200 ? (c && c(), e || p.inform((j || (j = b("BanzaiConsts"))).OK)) : (d && d(a), e || p.inform((j || (j = b("BanzaiConsts"))).ERROR))
                    }
                };
                k.push(g);
                g.send(a, !1)
    ...
    var l = "blue_total_messages_received",
        ...
        w = {
            ...
            _initialize: function() {
                ...
                })) : w.adapter.setHooks(w), w.adapter.setUnloadHook(w), b("NavigationMetrics").addListener(b("NavigationMetrics").Events.NAVIGATION_DONE, function(a, c) {
            ...
            post: function(a, c, d) {
                ...
                var f = (e = JSON.stringify(c)) != null ? e : "",
                    g = d == null ? void 0 : d.retry;
                ...
                if (k && (k.indexOf && (typeof k.indexOf == "function" && k.indexOf(a) != -1))) return;
                var l = f.length;
                s++;
                u++;
                ...
                if (d == null ? void 0 : d.signal) {
                    ...
                    b("BanzaiAdapter").send(w._prepForTransit(p), function() {
                        v++, t++, n.__meta.status = (i || (i = b("BanzaiConsts"))).POST_SENT, n.__meta.callback && n.__meta.callback()
                    }, function(a) {
